...
export default function Account() {
  return (
    <div className=" py-24 h-full w-full ">
      ...
      <div className=" px-2 h-36 w-full  mt-5 grid grid-flow-row-dense grid-cols-2  ">
        <NavLink to={"/"}>
          <div className="bg-white h-12 w-40 flex  ">
        ...
        <NavLink to={"/purchase"}>
          <div className="bg-white ml-1 h-12 w-40 flex  ">
            <h1 className="text-3xl  text-black/50  py-2 ml-2">
        ...
        <NavLink to={"/settings"}>
          <div className="bg-white h-12 -mt-5 w-40 flex  ">
            <h1 className="text-3xl  text-black/50  py-2 ml-2">
              <IoSettingsOutline />
            </h1>
        ...
        <NavLink to={"/contact"}>
          <div className="bg-white h-12 ml-1 -mt-5 w-40 flex  ">
            <h1 className="text-3xl  text-black/50  py-2 ml-2">
              <BiMessageMinus />
            </h1>
            <h1 className="font-sans text-xs py-4 font-semibold ml-2">
