  ...
  return (
    <div className=" pt-10 bg-custom   w-full md:w-full h-full  ">
      <div className="flex justify-between md:px-3 md:ml-0 px-1 ml-1">
        <h1 className="font-roboto md:font-bold  text-[10px]">LATEST DROP</h1>
      ...
      <div className="flex bg-custom justify-center h-[100px]">
        <button className="text-[9px] font-roboto h-7 w-32 md:w-36 border   border-black/65 mt-5 hover:bg-black hover:text-white hover:rounded-2xl ">
          DISCOVER MORE
        </button>
      </div>
    </div>
