  ...
  return (
    <div className="bg-custom ">
      ...
      <div className="flex justify-center mt-6">
            ...
            <h1 className="font-roboto text-xs opacity-60 cursor-pointer hover:text-red-500 hover:opacity-100">HOME</h1>
            </Link>
            <h1 className="font-roboto font-bold text-lg -mt-[6px] ml-2">/</h1>
            <Link to={'/account'}>
            <h1 className="font-roboto text-xs ml-2 opacity-50 cursor-pointer hover:text-red-500 hover:opacity-100 ">ACCOUNT</h1>
            </Link>
            <h1 className="font-roboto font-bold text-lg -mt-[6px] ml-2">/</h1>
            <h1 className="font-roboto text-xs ml-2 text-red-500 cursor-pointer ">PURCHASES</h1>
        </div>
